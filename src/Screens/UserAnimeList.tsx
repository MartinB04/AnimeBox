...
import { show_animes_script, show_user_anime_list_script } from '../Const/UrlConfig';
...
export const UserAnimeList = () => {
    ...
    const fetchAnimes = async () => {
        try {
            const response = await fetch(`${show_user_anime_list_script}?id_usuario=${userData?.username}`); // Replace with your server URL
